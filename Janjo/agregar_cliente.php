...
<body>
    ...
    <header class="page-header bg-img-cover-dash overlay overlay-30" style="background: rgb(1,76,255);background: linear-gradient(90deg, rgba(1,76,255,1) 0%, rgba(0,168,255,1) 100%);">
        <div class="container text-left" style="margin-top: 6rem;">
          <div class="row">
            <div class="col-lg-12">
                <h1 class="display-4 tct text-white">Clientes</h1>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title tct"><strong>Nuevo Cliente</strong></h5>
                      ...
                      <table class="table table-hover" width="100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td align="right">
                            <a class="btn btn-sm tct text-white bg-secondary rounded-pill lift-img-X-l" title="Editar: <?php echo $value->nombre_completo; ?>" href="modificar_doctor.php?id=<?php echo $value->id; ?>"><i class="material-icons-round">create</i>Editar</a>
                            <a class="btn btn-sm tct text-white bg-danger rounded-pill" title="Eliminar: <?php echo $value->nombre_completo; ?>" onclick="document.forms.cliente_<?php echo $value->id; ?>.submit();"><i class="material-icons-round">delete</i>Eliminar</a>
